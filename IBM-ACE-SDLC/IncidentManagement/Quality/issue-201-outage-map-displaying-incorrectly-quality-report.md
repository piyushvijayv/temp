# Quality Report -- Issue #201 -- Outage map displaying incorrectly
**Artifact:** `issue-201-outage-map-displaying-incorrectly-quality-report.md` | **Branch:** `work/issue-201-bob-sdlc` | **Generated:** 2026-07-24
...
applied to the fix for Issue #201. All gates passed. The fix is ready for PR review and merge.
...
Test Report: `issue-201-outage-map-displaying-incorrectly-test-plan.md`
...
|------|----------------------|--------|
| `SAP_ADMS_UpdateCrewStatus_Compute.esql` | Crew/OpCo validated before dispatch; error routed to SAP_ADMS_ErrorHandler | PASS |
...
|----------|-------------|--------|
| Design doc (`issue-201-outage-map-displaying-incorrectly-design.md`) | Executive summary, root cause, data flow | PASS |
| Test report (`issue-201-outage-map-displaying-incorrectly-test-plan.md`) | Coverage table, test data, all TCs numbered | PASS |
| ESQL source (`issue-201-outage-map-displaying-incorrectly-fix.esql`) | Header block with issue, date, rules applied | PASS |
...
|-------|-----------|-----------|-------------|------------|
| Functions implemented match designed | issue-201-outage-map-displaying-incorrectly-design.md | issue-201-outage-map-displaying-incorrectly-fix.esql | issue-201-outage-map-displaying-incorrectly-test-plan.md | PASS |
...
The following checks were completed before committing to branch `work/issue-201-bob-sdlc`:
...
| 11 | Design Consistency | Code matches design doc: issue-201-outage-map-displaying-incorrectly-design.md | PASS |
| 12 | Test Consistency | Test report references same functions as code: issue-201-outage-map-displaying-incorrectly-test-plan.md | PASS |
