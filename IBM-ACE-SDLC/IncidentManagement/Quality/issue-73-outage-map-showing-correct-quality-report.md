# Quality Report -- Issue #73 -- Outage map are not showing correct time
**Artifact:** `issue-73-outage-map-showing-correct-quality-report.md` | **Branch:** `work/issue-73-bob-sdlc` | **Generated:** 2026-07-24
...
applied to the fix for Issue #73. All gates passed. The fix is ready for PR review and merge.
...
Test Report: `issue-73-outage-map-showing-correct-test-plan.md`
...
|----------|-------------|--------|
| Design doc (`issue-73-outage-map-showing-correct-design.md`) | Executive summary, root cause, data flow | PASS |
| Test report (`issue-73-outage-map-showing-correct-test-plan.md`) | Coverage table, test data, all TCs numbered | PASS |
| ESQL source (`issue-73-outage-map-showing-correct-fix.esql`) | Header block with issue, date, rules applied | PASS |
...
|-------|-----------|-----------|-------------|------------|
| Functions implemented match designed | issue-73-outage-map-showing-correct-design.md | issue-73-outage-map-showing-correct-fix.esql | issue-73-outage-map-showing-correct-test-plan.md | PASS |
...
The following checks were completed before committing to branch `work/issue-73-bob-sdlc`:
...
| 11 | Design Consistency | Code matches design doc: issue-73-outage-map-showing-correct-design.md | PASS |
| 12 | Test Consistency | Test report references same functions as code: issue-73-outage-map-showing-correct-test-plan.md | PASS |
