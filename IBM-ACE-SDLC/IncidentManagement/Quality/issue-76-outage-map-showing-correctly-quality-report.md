# Quality Report -- Issue #76 -- Outage map is not showing correctly for NPS
**Artifact:** `issue-76-outage-map-showing-correctly-quality-report.md` | **Branch:** `work/issue-76-bob-sdlc` | **Generated:** 2026-07-24
...
applied to the fix for Issue #76. All gates passed. The fix is ready for PR review and merge.
...
Test Report: `issue-76-outage-map-showing-correctly-test-plan.md`
...
|----------|-------------|--------|
| Design doc (`issue-76-outage-map-showing-correctly-design.md`) | Executive summary, root cause, data flow | PASS |
| Test report (`issue-76-outage-map-showing-correctly-test-plan.md`) | Coverage table, test data, all TCs numbered | PASS |
| ESQL source (`issue-76-outage-map-showing-correctly-fix.esql`) | Header block with issue, date, rules applied | PASS |
...
|-------|-----------|-----------|-------------|------------|
| Functions implemented match designed | issue-76-outage-map-showing-correctly-design.md | issue-76-outage-map-showing-correctly-fix.esql | issue-76-outage-map-showing-correctly-test-plan.md | PASS |
...
The following checks were completed before committing to branch `work/issue-76-bob-sdlc`:
...
| 11 | Design Consistency | Code matches design doc: issue-76-outage-map-showing-correctly-design.md | PASS |
| 12 | Test Consistency | Test report references same functions as code: issue-76-outage-map-showing-correctly-test-plan.md | PASS |
