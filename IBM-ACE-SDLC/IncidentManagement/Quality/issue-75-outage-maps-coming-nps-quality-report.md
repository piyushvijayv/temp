# Quality Report -- Issue #75 -- outage maps are not coming for NPS
**Artifact:** `issue-75-outage-maps-coming-nps-quality-report.md` | **Branch:** `work/issue-75-bob-sdlc` | **Generated:** 2026-07-24
...
applied to the fix for Issue #75. All gates passed. The fix is ready for PR review and merge.
...
Test Report: `issue-75-outage-maps-coming-nps-test-plan.md`
...
|----------|-------------|--------|
| Design doc (`issue-75-outage-maps-coming-nps-design.md`) | Executive summary, root cause, data flow | PASS |
| Test report (`issue-75-outage-maps-coming-nps-test-plan.md`) | Coverage table, test data, all TCs numbered | PASS |
| ESQL source (`issue-75-outage-maps-coming-nps-fix.esql`) | Header block with issue, date, rules applied | PASS |
...
|-------|-----------|-----------|-------------|------------|
| Functions implemented match designed | issue-75-outage-maps-coming-nps-design.md | issue-75-outage-maps-coming-nps-fix.esql | issue-75-outage-maps-coming-nps-test-plan.md | PASS |
...
The following checks were completed before committing to branch `work/issue-75-bob-sdlc`:
...
| 11 | Design Consistency | Code matches design doc: issue-75-outage-maps-coming-nps-design.md | PASS |
| 12 | Test Consistency | Test report references same functions as code: issue-75-outage-maps-coming-nps-test-plan.md | PASS |
