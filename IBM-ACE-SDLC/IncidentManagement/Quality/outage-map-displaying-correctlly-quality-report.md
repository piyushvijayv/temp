# Quality Report — Outage Map are not displaying correctlly
...
applied to the fix for Issue #72. All gates passed. The fix is ready for PR review and merge.
...
Test Report: `outage-map-displaying-correctlly-test-plan.md`
...
|----------|-------------|--------|
| Design doc (`outage-map-displaying-correctlly-design.md`) | Executive summary, root cause, data flow | PASS |
| Test report (`outage-map-displaying-correctlly-test-plan.md`) | Coverage table, test data, all TCs numbered | PASS |
| ESQL source (`outage-map-displaying-correctlly-fix.esql`) | Header block with issue, date, rules applied | PASS |
...
|-------|-----------|-----------|-------------|------------|
| Functions implemented match designed | outage-map-displaying-correctlly-design.md | outage-map-displaying-correctlly-fix.esql | outage-map-displaying-correctlly-test-plan.md | PASS |
...
The following checks were completed before committing to branch `work/issue-72-bob-sdlc`:
...
| 11 | Design Consistency | Code matches design doc: outage-map-displaying-correctlly-design.md | PASS |
| 12 | Test Consistency | Test report references same functions as code: outage-map-displaying-correctlly-test-plan.md | PASS |
