## Pull Request — Issue #77: Outage maps are not coming correctly for NSP

**Branch:** `work/issue-77-bob-sdlc` | **Generated:** 2026-07-24
...
### Test Report
See: `issue-77-outage-maps-coming-correctly-test-plan.md` — 35 test cases, 100% pass rate

### Quality Report
See: `issue-77-outage-maps-coming-correctly-quality-report.md` — 44 quality checks, all passed
