## Pull Request — Issue #201: Outage map displaying incorrectly

**Branch:** `work/issue-201-bob-sdlc` | **Generated:** 2026-07-24
...
### Test Report
See: `issue-201-outage-map-displaying-incorrectly-test-plan.md` — 35 test cases, 100% pass rate

### Quality Report
See: `issue-201-outage-map-displaying-incorrectly-quality-report.md` — 44 quality checks, all passed
