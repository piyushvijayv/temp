# ICA Quality Report — Issue #75: outage maps are not coming for NPS

**Branch:** `work/issue-75-bob-sdlc` | **Run ID:** `run-issue-75-1784868846323` | **Generated:** 2026-07-24

---

### Quality Gate Summary — Issue #75
...
| ID | Criterion | Status |
|----|-----------|--------|
| AC-001 | Fix resolves the reported behaviour: outage maps are not coming for NPS | PASS |
...
| File | Type | Location |
|------|------|----------|
| `issue-75-outage-maps-coming-nps-design.md` | Design Document | Committed to `work/issue-75-bob-sdlc` |
| `issue-75-outage-maps-coming-nps-fix.esql` | ESQL Code Patch | Committed to `work/issue-75-bob-sdlc` |
| `issue-75-outage-maps-coming-nps-test-plan.md` | Test Case Report | Committed to `work/issue-75-bob-sdlc` |
| `issue-75-outage-maps-coming-nps-quality-report.md` | Quality Report | Committed to `work/issue-75-bob-sdlc` |
| `PR-Description-issue-75-outage-maps-coming-nps-ICA.md` | SDLC Artifact | Committed to `work/issue-75-bob-sdlc` |

> Run ID: `run-issue-75-1784868846323` | Correction attempts: 0
...
## Pull Request — Issue [#37](https://github.com/piyushvijayv/temp/issues/37): outage maps are not coming for NPS

**Branch:** `work/issue-75-bob-sdlc` | **Run ID:** `run-issue-75-1784868846323`
**GitHub Issue:** [#37](https://github.com/piyushvijayv/temp/issues/37) | **Type:** bug | **Priority:** medium
...
**Other:**
  - `sdlc-workflow-automation/ica-issue-state-75.json`
  - `sdlc-workflow-automation/PR-Description-issue-75-outage-maps-coming-nps-ICA.md`


---

### Acceptance Criteria
- [x] Fix resolves the reported behaviour: outage maps are not coming for NPS
...
> **ICA Agent Run:** `run-issue-75-1784868846323` | Correction attempts: 0
> **GitHub Issue:** [#37](https://github.com/piyushvijayv/temp/issues/37)
